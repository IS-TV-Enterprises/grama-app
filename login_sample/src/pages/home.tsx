      ...
      {state.isAuthenticated ? (
        ...
        <div className="content">
          ...
          <h4 className={"spa-app-description"}>
            ...
            .
            <br />
            This applicaiton is uses ballerina for all integration purposes. all
            API calls are made to the ballerina backend. For more information
            about ballerina visit&nbsp;
            <a href="https://ballerina.io/">ballerina.io</a>
          </h4>
          <button
