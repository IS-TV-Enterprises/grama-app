  ...
  const sectionItems = [
    {
      ...
      icon: (
        <AssignmentTurnedInOutlinedIcon
          sx={{ fontSize: 100, color: grey[800], mb: 1 }}
        />
      ),
      sentence: "Apply for Grama Certificate",
      description:
        "Apply for a Grama Certificate with ease. Utilize our smart digital solution designed to for efficient processing of your requests.",
    },
    {
      id: 2,
      icon: (
        ...
        >
          ...
          <Box>
            ...
            >
              ...
              >
                We help you seamlessly acquire your Garam certificates. Log in
                now to get started!
              </Typography>
            </Container>
            <Box>
